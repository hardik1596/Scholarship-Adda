...
<div class="adminpart1">	
 <div class="adminnavabar">
    <div class="adminlog"> 
<img src="img/logo1.jpeg" id="lo" > 
</div>
<div class="adminoption">
    <h3>Stats</h3>
    <ul>
    <!-- <li>Dashboard</li> -->
    <li><a href="user-list.php"><i class="fas fa-users"></i> &nbsp;User List </a></li>

    <li><a href="post-scholarship.php"> <i class="far fa-calendar-plus"></i> &nbsp;Add scholarship </a></li>
    <li class="running"><a href="scholarship-list.php"><i class="fas fa-cogs"></i>&nbsp; Manage scholarship </a></li>
    </ul>
    <h3>Account</h3>
    <ul>
