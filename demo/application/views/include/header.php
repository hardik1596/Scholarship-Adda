...
<header id="sty">
  <i class="fas fa-window-close nav-in" onclick="hide()" style="font-size: 30px; display: none; "></i>
  <nav>
    <div class="logo">
     <a href="<?php echo base_url()?>home/index"> <img src="<?php echo base_url()?>asset/img/logo1.png" id="lo" >
     </a>
    </div>
    ...
    <ul>
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="<?php echo base_url()?>home/cdata(MTech)";>M.Tech</a>
